...
stroke = pd.read_csv('https://raw.githubusercontent.com/123manju900/Capstone-AzureML/main/stroke-prediction-dataset.csv')
...
def clean_data(dp):
    ...
    dp.pop('id')
    x_df['bmi'].fillna(x_df['bmi'].median(), inplace =True)
